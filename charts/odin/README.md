...
| `elasticsearch.sysctlImage.registry`         | Elasticsearch sysctlImage registry                                                                                                                                                                                                                                      | `docker.io`                   |
| `elasticsearch.sysctlImage.repository`       | Elasticsearch sysctlImage repository                                                                                                                                                                                                                                    | `bitnamilegacy/os-shell`      |
