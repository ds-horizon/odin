...
| `elasticsearch.sysctlImage.registry`         | Image registry                                                                                                                                                                                                                                                          | `docker.io`                   |
| `elasticsearch.sysctlImage.repository`       | Image repository                                                                                                                                                                                                                                                        | `bitnamilegacy/os-shell`      |
| `elasticsearch.sysctlImage.tag`              | Image tag                                                                                                                                                                                                                                                               | `12-debian-12-r50`            |
